...
export default function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-mint-light via-white to-mint-light/50 p-20">
      {/* Background Decor */}
      ...
      <div className="container mx-auto px-4 z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 text-gray-900 leading-tight">
            Healing Starts With <span className="text-gradient">Conversation</span>
          </h1>
          
          <p className="text-lg md:text-xl text-gray-600 mb-8 leading-relaxed max-w-xl">
            Talk2Nebiah is your safe space for real conversations about life&apos;s struggles. 
            Connect, share, and find support for stress, anxiety, and burnout in a 
        ...
        >
            ...
            <div className="relative w-full h-full bg-gradient-to-tr from-mint to-mint-medium rounded-[2rem] overflow-hidden shadow-2xl flex items-center justify-center">
                <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-10"></div>
                <div className="text-white text-center p-8">
                    <svg className="w-32 h-32 mx-auto mb-6 opacity-90" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                    </svg>
                    <p className="text-2xl font-semibold opacity-90">"You are not alone."</p>
                </div>
