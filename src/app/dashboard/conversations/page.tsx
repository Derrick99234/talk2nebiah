...
export default function WhatsAppInbox() {
  ...
  const handleSimulateIncoming = (e: React.FormEvent) => {
    ...
    addMockIncomingMessage(activePatientId, simulateText.trim());
    setSimulateText('');
  ...
  return (
    <div className="flex h-[calc(100vh-8rem)] bg-slate-900 border border-slate-800 rounded-2xl overflow-hidden shadow-xl">
      
      {/* 1. CHAT LIST SIDEBAR */}
      <div className="w-80 border-r border-slate-800 flex flex-col bg-slate-900/60 shrink-0">
      ...
      <div className="w-80 border-l border-slate-800 p-6 flex flex-col justify-between bg-slate-900/60 shrink-0 overflow-y-auto">
